...
def baseline(train_test_Dict):
    ...
    ### BASELINES
    # BASED ON: df[df['Narcissism_Category'] == 0].shape[0] / sample_size (or similar)
    narc_baseline = 0.6707578843084374
    psych_baseline = 0.6978920138697782
    mach_baseline = 0.7049920193736584


    return narc_baseline, psych_baseline, mach_baseline
